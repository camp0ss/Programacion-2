...
public class PanelBurbuja extends javax.swing.JPanel {
    ...
    DefaultListModel ordenado = new DefaultListModel();
    ...
    private void jBOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBOrdenarActionPerformed
            ...
            //Limpiar el modelo, en cada vez que se pulsa el boton 
            listamodeloOrdenado.clear();
            
            //For para agregar los elementos de listamodelo a listamodeloOrdenado
            for(int i = 0; i < this.listamodelo.getSize();i++ ){
                //Se recoge el elemeto de listamodelo y se agrega a listamodeloOrdenado
                listamodeloOrdenado.addElement(listamodelo.elementAt(i));
            }        
